-- Complete Database Schema Matching All TypeORM Entities Exactly
-- This file creates all tables with all required fields based on entity definitions
-- Use this for fresh database setup or complete schema recreation
...
CREATE TABLE IF NOT EXISTS users (
    ...
    updatedAt DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    INDEX IDX_users_loginID (loginID),
